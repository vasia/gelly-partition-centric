...
/**
 * Testing the PCConnectedComponents on Twitter follower dataset
 */
public class Twitter {
    public static void main(String[] args) throws Exception {
        ...
        Graph<Long, Long, NullValue> graph = Graph
                .fromCsvReader(
                        wrapper.getInputRoot() + "twitter/out.twitter.data",
    ...
    private static void printErr() {
        ...
        System.err.printf("Run \"java %s pc local\" for local partition-centric%n", Twitter.class);
        System.err.printf("Run \"java %s vc local\" for local vertex-centric%n", Twitter.class);
        System.err.printf("Run \"java %s pc remote\" for remote partition-centric%n", Twitter.class);
        System.err.printf("Run \"java %s pc remote\" for remote partition-centric%n", Twitter.class);
        System.exit(-1);
    }
}
